...
import {getProducts} from "../redux/action/loginAction";
                    ...
                    <div className='artikul'>
                        ...
                        <div className="row me-0">
                            ...
                            <div className="col-5 senter">
                                ...
                                {props.getProducts.colorname}

                                {/*<img src={} alt=""/>*/}
                                {/*<figure onMouseMove={this.handleMouseMove} style={this.state}>*/}
                                {/*    <img className="zoom" src={src} />*/}
                                {/*</figure>*/}

                            </div>
                            <div className="col-5 ">
                                <span>{data.price}sum <del>{data.oldprice}sum</del></span>
                                ...
                                <img className="w-25 mt-3 mb-3" src={API_PATH + data.brandimage} alt=""/>
...
export default connect (null, {getProducts}) ( ModalExample);