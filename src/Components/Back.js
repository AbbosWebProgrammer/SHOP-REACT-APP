...
const Back = (props) => {
    ...
    useEffect(() => {
        props.getCardBack(window.location.pathname.split('/')[2]);
    },[])
                ...
                {props.back.map((data1,index) => (
                    <div className="artikul" key={index}>
                        <div>
                            ...
                            <h1 className="ops">{data1.productname}</h1>
                            <div className="d-flex">

                                <p className="ms-3 my-1">Купили более {data1.buy_quantity} раз</p>
                            </div>
                        </div>
                    ...
                    {/* productpice
                    productoldprice r */}
                        <h1>{productprice.length!==0?productprice:data1.colors[0].price} сум</h1>&nbsp;
                        <del>{productoldprice.length!==0?productoldprice:data1.colors[0].oldprice} сум</del>
                    </span>
                        ...
                        <div className="w-50 back">
                            ...
                            {
                                data1.description && data1.description.map((word) => (
                            ...
                            {
                                data1.additional &&  data1.additional.map((wordin) => (
                                    <div className="des">
                                        <h1 className="mb-5 mt-5">{wordin.name}</h1>
                                        {
                                            wordin.items.map((sostav) => (
                                                <div className="mt-3 mb-3">
                                                    <th className="sos"><span className="text-dark me-4">{sostav.paramscell}     -----------------------------------</span></th>
                                                    <td className="sos2">{sostav.paramscelldecor}</td>
                                                </div>
                                            ))
                                        }
                                    </div>
